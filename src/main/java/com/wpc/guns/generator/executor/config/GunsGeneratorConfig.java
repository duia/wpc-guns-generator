...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.wpc.guns.admin.common.persistence.model");
        packageConfig.setMapper("com.wpc.guns.admin.common.persistence.dao");
        packageConfig.setXml("com.wpc.guns.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.wpc.guns.admin");
        contextConfig.setCoreBasePackage("com.wpc.guns.core");
